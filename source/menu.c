...
void DrawMenu(MenuInfo* currMenu, u32 index, bool fullDraw, bool subMenu)
{
    ...
    if (fullDraw) { // draw full menu
        ...
        DrawStringF(menublock_x0, menublock_y1 + 30, top_screen, "SELECT:        Unmount SD");
        DrawStringF(menublock_x0, menublock_y1 + 40, top_screen, "START:         Reboot");
        DrawStringF(menublock_x0, menublock_y1 + 50, top_screen, "LEFT + START:  Shutdown");
